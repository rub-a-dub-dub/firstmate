...
- Tracked shell scripts must pass `shellcheck`, test scripts included; `bin/fm-lint.sh`'s header owns the exact file set and which codes only run in CI.
