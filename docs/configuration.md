...
FM_CREW_STATE_BIN=bin/fm-crew-state.sh   # test override for the current-state reader used by watcher triage: the provably-working classification, and the wedge timer's parked-gate wait evidence
